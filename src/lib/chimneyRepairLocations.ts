...
export const chimneyRepairLocations: ChimneyRepairLocation[] = [
  {
    ...
    metadataDescription:
      "Professional chimney repair in Bragg Creek for cracked mortar, damaged brick, leaks, crowns, caps, and weathered masonry. Request an inspection.",
    description:
    ...
    whyChooseItems: [
      ...
      "Repairs for crowns, caps, brick, and mortar",
  ...
  },
  {
    ...
    metadataDescription:
      "Reliable chimney repair in Longview, Alberta, including brick replacement, tuckpointing, crown and cap work, leak assessment, and masonry restoration.",
    description:
  ...
  },
  {
    ...
    metadataDescription:
      "Chimney repair in Kananaskis for mountain homes, cabins, and properties. We repair cracked masonry, mortar joints, crowns, caps, and water damage.",
    description:
  ...
  },
  {
    ...
    metadataDescription:
      "Professional chimney repair in Sundre, Alberta. DMG Masonry repairs brick, mortar, chimney crowns, caps, leaks, and weather-damaged masonry.",
    description:
    ...
    whyChooseItems: [
      ...
      "Attention to crowns and moisture entry",
  ...
  },
  {
    ...
    metadataDescription:
      "Expert chimney repair in Three Hills, Alberta, for cracked brick, failing mortar, damaged crowns, leaks, and unstable masonry. Book an assessment.",
    description:
  ...
  },
  {
    ...
    metadataDescription:
      "Chimney repair in Drumheller for cracked mortar, loose or damaged brick, crown deterioration, and leaks. Restore your chimney with DMG Masonry.",
    description:
    ...
    whyChooseItems: [
      ...
      "Durable crown and joint detailing",
  ...
  },
  {
    ...
    metadataDescription:
      "Dependable chimney repair in Claresholm, Alberta. We restore cracked mortar, damaged brick, crowns, caps, leaks, and weathered masonry.",
    description:
    ...
    benefits: [
      ...
      "Crown & Cap Repair",
      "Weather-Exposed Brick Replacement",
